...
@Component({
  selector: "app-material-filled",
  templateUrl: "./material-filled.component.html",
  styleUrls: ["./material-filled.component.scss"],
})
export class MaterialFilledComponent implements OnInit {
  searchWord = "";
  constructor() {}
