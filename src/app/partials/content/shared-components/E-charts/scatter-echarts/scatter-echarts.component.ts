...
import { series } from "../../Apex-chart/area-apx-chart/data";

@Component({
  selector: "app-scatter-echarts",
  templateUrl: "./scatter-echarts.component.html",
  styleUrls: ["./scatter-echarts.component.scss"],
})
export class ScatterEchartsComponent implements OnInit {
  whiteColor: string;
  primaryColor: string;
