...
@Component({
  selector: "app-apex-datetime-x-axis",
  templateUrl: "./apex-datetime-x-axis.component.html",
  styleUrls: ["./apex-datetime-x-axis.component.scss"],
})
export class ApexDatetimeXAxisComponent implements OnInit {
  whiteColor: string;
  primaryColor: string;
