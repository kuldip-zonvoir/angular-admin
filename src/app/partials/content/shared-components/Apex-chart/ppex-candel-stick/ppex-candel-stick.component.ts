...
@Component({
  selector: "app-ppex-candel-stick",
  templateUrl: "./ppex-candel-stick.component.html",
  styleUrls: ["./ppex-candel-stick.component.scss"],
})
export class PpexCandelStickComponent implements OnInit {
  whiteColor: string;
  primaryColor: string;
  ...
  constructor(private _config: ConfigService) {
    ...
    this.chartOptions = {
      ...
      plotOptions: {
        candlestick: {
          colors: {
            upward: this.successColor,
            downward: this.secondaryColor,
          },
          wick: {
            useFillColor: true,
          },
