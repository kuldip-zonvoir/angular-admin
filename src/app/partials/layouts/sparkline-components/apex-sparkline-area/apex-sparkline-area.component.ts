...
const sparkLineData = [10, 45, 54, 50, 80];
@Component({
  selector: "app-apex-sparkline-area",
  templateUrl: "./apex-sparkline-area.component.html",
  styleUrls: ["./apex-sparkline-area.component.scss"],
})
export class ApexSparklineAreaComponent implements OnInit {
  @Input() width: number;
  @Input() height: number;
